Welcome to my README file for a GitHub repository containing MySQL datasets from Kaggle related to case studies on topics like Shark Tank, data science jobs, Google Play Store, and Swiggy:
